...
from app.models import customer, product, price, po, payment, rma

# 연동이 완료된 라우터들을 가져옵니다.
from app.routers import customer_router, product_router, price_router, po_router, payment_router, rma_router
